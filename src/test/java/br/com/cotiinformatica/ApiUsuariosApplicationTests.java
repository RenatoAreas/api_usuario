...
class ApiUsuariosApplicationTests {
	...
	public void criarContaTest() throws Exception {
		...
		mock.perform(post("/api/usuarios/criar-conta").contentType("application/json")
	...
	public void autenticarTest() throws Exception {
		...
		MvcResult result = mock.perform(post("/api/usuarios/autenticar").contentType("application/json")
	...
	public void atualizarDadosTest() throws Exception {
		...
		mock.perform(put("/api/usuarios/atualizar-dados").header("Authorization", "Bearer " + accessToken)
